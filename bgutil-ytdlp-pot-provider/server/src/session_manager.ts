    ...
    private logger: Logger;
        ...
        constructor(
            ...
            if (!SessionManager.hasDom) {
                                        ...
                                        this.logger.log("JSDOM initialized.");            }
            this.logger.log("SessionManager constructor finished");
        }
